...
```bash
pytest tests/ -v                    # All 777 tests (900+ with slow matrix)
...
pytest tests/test_connectors.py     # SaaS connectors with mocked APIs (87, includes 40 Linear + 28 Google Workspace tests)
...
|-----|---------|-------------|
| **test** | All pushes + PRs | Unit tests on Python 3.11 and 3.12 (777 tests) |
