...
```bash
pytest tests/ -v                    # All 955 tests (1,165 collected with slow/integration)
...
pytest tests/test_cli.py            # CLI integration + 8 domain/framework combos + neo4j types + validation + auto-slug + Linear + Google Workspace + Claude Code connectors (48)
